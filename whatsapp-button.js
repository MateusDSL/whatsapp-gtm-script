...
(function() {
    ...
    function handleSubmit(e) {
        ...
        if (GOOGLE_SCRIPT_WEB_APP_URL) {
            fetch(GOOGLE_SCRIPT_WEB_APP_URL, {
                ...
                console.error("Erro de rede ao enviar para o Google Script:", error);
            });
        } else {
    ...
    // --- Funções de Criação de HTML (sem alterações) ---
    ...
    function createModal() {
        ...
        panel.innerHTML = `
            ...
            <div class="whatsapp-modal-body">
                <div class="whatsapp-fade-in" style="opacity:0;transform:translateY(10px);transition:all .3s ease"><h3 class="whatsapp-modal-title">Fale Conosco</h3><p class="whatsapp-modal-description">Deixe seus dados e inicie uma conversa no WhatsApp.</p></div>
                <div id="whatsapp-status-message" class="whatsapp-status-message" style="display:none"></div>
                <form id="whatsapp-form">
                    <div class="whatsapp-form-group whatsapp-fade-in" style="opacity:0;transform:translateY(10px);transition:all .3s ease"><label for="whatsapp-name" class="whatsapp-form-label">Nome</label><div class="whatsapp-input-container"><svg class="whatsapp-input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><input type="text" id="whatsapp-name" class="whatsapp-input" placeholder="Seu nome completo" required></div></div>
                    <div class="whatsapp-form-group whatsapp-fade-in" style="opacity:0;transform:translateY(10px);transition:all .3s ease"><label for="whatsapp-phone" class="whatsapp-form-label">Telefone (WhatsApp)</label><div class="whatsapp-input-container"><svg class="whatsapp-input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg><input type="tel" id="whatsapp-phone" class="whatsapp-input" placeholder="(XX) XXXXX-XXXX" required maxlength="15"></div></div>
                    <div class="whatsapp-fade-in" style="opacity:0;transform:translateY(10px);transition:all .3s ease;margin-top:16px"><button type="submit" id="whatsapp-submit-btn" class="whatsapp-submit-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347"/></svg>Iniciar Conversa</button></div>

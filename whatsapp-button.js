// WhatsApp Button Script - VERSÃO COM EXPIRAÇÃO DE 1 DIA
(function() {
    // --- CONFIGURAÇÕES ---
    ...
    const EXPIRATION_TIME_IN_HOURS = 24; // **NOVO**: Tempo de expiração em horas
    ...
    async function handleSubmit(e) {
       ...
       try {
            ...
            // **ALTERADO**: Salva o estado com um timestamp no localStorage
            const submission = {
                submitted: true,
                timestamp: new Date().getTime() // Pega a hora atual em milissegundos
            };
    ...
    function createWidget() {
        ...
        // **LÓGICA ALTERADA**: Verifica se a submissão é válida (menos de 24h)
        ...
        if (submissionDataString) {
            ...
            if (timeSinceSubmission < expirationInMs) {
                ...
                // Já expirou, então removemos o dado antigo para mostrar o formulário novamente
